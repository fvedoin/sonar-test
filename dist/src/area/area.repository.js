...
let AreaRepository = class AreaRepository extends abstract_repository_1.AbstractRepository {
    constructor(areaModel, connection) {
    ...
    async findAndPopulate(where, populate) {
...
AreaRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(area_entity_1.Area.name)),
