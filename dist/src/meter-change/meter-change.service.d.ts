...
export declare class MeterChangeService {
    private readonly meterChangeRepository;
    constructor(meterChangeRepository: MeterChangeRepository);
    ...
    findOne(_id: string): Promise<import("./entities/meter-change.entity").MeterChanges>;
    update(_id: string, updateMeterChangeDto: UpdateMeterChangeDto): Promise<import("mongoose").Document<unknown, any, import("./entities/meter-change.entity").MeterChanges> & import("./entities/meter-change.entity").MeterChanges & Required<{
        _id: import("mongoose").Types.ObjectId;
    }>>;
